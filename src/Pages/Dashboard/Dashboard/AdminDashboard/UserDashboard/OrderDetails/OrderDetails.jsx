...
const OrderDetails = () => {
  // Initialize orderStatus with "Payment Pending"
  const [orderStatus, setOrderStatus] = useState("Payment Pending");
      ...
      <div>
        <ol className="relative text-gray-500 border-l border-gray-200 dark:border-gray-700 dark:text-gray-400">
          <li className="mb-10 ml-6">
            ...
            <h3 className="font-medium leading-tight">{orderStatus}</h3>

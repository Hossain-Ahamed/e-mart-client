    ...
    return (
      ...
      >
        
          {
            category.map(categories => ( <SwiperSlide
                key={categories._id}>
            <div className="w-36 h-36 md:w-52 md:h-48 lg:w-[370px] lg:h-96 bg-white shadow-md">
            <Link>
      ...
      >
        ...
        <SwiperSlide><img src="https://cdn11.bigcommerce.com/s-vptmq0v2zd/images/stencil/305x395/products/86/498/11__18274.1606378004.jpg?c=1" alt="" /></SwiperSlide>
            ...
            <p className='lg:text-lg font-semibold my-3 text-red-900'>Garlic</p>
            ...
            <button className='bg-red-900 text-white font-bold w-36 h-10 rounded-full'>+ Add to Cart</button>
            </div>
...
export default BeautyBestSellers;